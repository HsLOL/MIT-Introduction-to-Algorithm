...
class PriorityQueue:
    ...
    #         least = r
    #     if least != i:
    #         self.queue[i], self.queue[least] = self.queue[least], self.queue[i]
    ...
    def append(self, key):
        ...
        # self.queue.insert(len(self.queue), sys.maxsize)
        ...
        while i > 1 :
            ...
            if key < self.queue[parent]:
                self.queue[parent], self.queue[i] = key, self.queue[parent]
                i = self.parent(i)
            else:
                break
